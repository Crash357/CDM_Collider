...
![Vertex-Auswahl](images/verts-hull.png)
...
4. Component landet in `GEO_Components`

Normalen zeigen **nach außen**. Viewport-Shading bleibt unverändert.

Für gerade, achsparallele Wände ist [Faces → AABB](Faces-AABB.md) meist enger. Hull für Schrägen, Erker, unregelmäßige Teile.
